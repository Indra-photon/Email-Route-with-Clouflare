...
// Create the customize-app directory
const targetDir = path.join(__dirname, 'app', '(app)', 'dashboard', 'customize-app');
...
const pageFilePath = path.join(targetDir, 'page.tsx');
fs.writeFileSync(pageFilePath, pageContent);
console.log('✓ Page file created:', pageFilePath);
console.log('\n✓ Customize App page setup complete!');
