      ...
      <div className="bg-neutral-900 border-t border-neutral-800">
        <Container className="py-16 max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <CustomLink
              href="/sign-up"
              className="px-7 py-3.5 bg-white text-neutral-900 font-semibold text-sm rounded-xl hover:bg-neutral-100 transition-colors"
            >
              Get started free
            </CustomLink>
            <CustomLink
              href="/pricing"
              className="px-7 py-3.5 border border-neutral-700 text-neutral-300 font-semibold text-sm rounded-xl hover:border-neutral-500 transition-colors"
            >
              View pricing
            </CustomLink>
          </div>
