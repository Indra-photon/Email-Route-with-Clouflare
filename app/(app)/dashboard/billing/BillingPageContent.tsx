...
export default function BillingPageContent() {
  ...
  return (
    <div className="space-y-6 border border-neutral-400 rounded-lg p-4 min-h-screen">
      ...
      {/* Billing contact */}
      <p className="font-schibsted text-xs text-neutral-400 text-center">
        Billing questions?{" "}
        <a href="mailto:billing@syncsupport.app" className="text-sky-700 hover:text-sky-800 underline transition-colors">
          billing@syncsupport.app
        </a>
      </p>
