...
export function StatusBreakdownChart({ domains, aliases }: StatusBreakdownChartProps) {
  ...
  return (
    <div className="bg-white rounded-xl border border-neutral-200 p-5 flex flex-col h-full gap-4">
          ...
          {data.map((slice) => (
            <div key={slice.label} className="flex items-center justify-between">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs font-schibsted text-neutral-500">{slice.label}</span>
              </div>
